...
use crate::{
	dependency::graph::DependencyGraph, logging::messages::*, model::vas_model::{AbstractVas, VasTransition},
...
fn generate_unique_trace(
	...
	trace_trie.insert_if_not_exists(&trace);
